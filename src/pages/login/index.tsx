      ...
      >
        ...
        <div>
          ...
          <input
            ...
            placeholder="••••••••"
            className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500  placeholder-gray-400 dark:placeholder-gray-500"
            // className="w-full px-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400"
          />
        </div>
...
//             type="email"
//             placeholder="e.g., user@example.com"
//             className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
//           />
//         </div>
...
//             value={role}
//             onChange={(e) => setRole(e.target.value as "admin" | "editor")}
//             className="w-auto px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md appearance-none bg-white text-black dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
//           >
//             <option className="text-black bg-white" value="admin">
//               Admin
//             </option>
